...
// A subsidiary of Rose of Jericho Community Development Center
        ...
        <>
            <section className="">
                <div className="flex flex-col md:flex-row  md:space-x-0 space-y-2 md:space-y-0 " >
                    <div className="bg-opacity-70 p-20 pb-0 md:pb-10 md:w-1/2">
                        <h2 className="text-6xl font-thin mb-4 text-tc-gold fonseca_thin md:mt-10">Take the first step toward your transformed self</h2>
                        <p className="text-lg mb-12 mt-6 text-gray-600">
                        ...
                        <a
                            ...
                            className="bg-tc-blue text-white text-tc-blue font-bold px-8 py-4 rounded-lg hover:bg-yellow-400 transition duration-300"
                        >
                            Join our Community
                        </a>
                    </div>

                    <div className="bg-opacity-90 p-20 pb-0 md:pb-10 md:w-1/2 HL_imgSample">
                        <div className='HL_imgSample1' style={{ background: `url(${apiData.imgUri}49506453.jpeg) center`, backgroundSize: "cover", }}></div>
                        <div className='HL_imgSample2'>
                            <div className='bg-tc-gold HL_imgSample2_sub1 bg-gray-600'>
                                <h3 className='fonseca text-white'>Transformation is a form of transition</h3>
                            </div>
                            <div className='HL_imgSample2_sub2' style={{ background: `url(${apiData.imgUri}39191038.jpeg) center`, backgroundSize: "cover", }}></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative bg-gray-900 text-white py-16">
                ...
                <div className="relative container mx-auto px-6 md:px-12 flex flex-col items-center text-center">
                    ...
                    <p className="mt-4 text-lg md:text-xl max-w-4xl text-center">
            ...
            <section
                ref={ref6}
                className={`py-24 bg-gray-900 bg-gradient-to-r from-tc-blue to-yellow-700 text-white transition-all duration-1000 ${inView6 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                    }`}
            >
            ...
            <section
                ref={ref3}
                className={`py-24 transition-all duration-1000 ${inView3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                    }`}
            >
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={index} className="group cursor-pointer">
                                ...
                                <h3 className="font-cormorant text-2xl font-bold">{trip.country}</h3>
                                <p className="text-gray-600">{trip.month}</p>
                            </div>
                        ))}
                    </div>
                </div>
...
{/* <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6">Welcome to The Transformation Collective</h2>
...
//         <a
//           href="/about"
//           className="text-tc-blue font-semibold hover:text-tc-gold transition duration-300"
//         >
//           Learn More About Us →
//         </a>
//       </div>
