...
import {
  ...
  Quote,
  Droplet,
  Video as LucideIcon, ExternalLink
} from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="">
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden shadow-lg bg-black">
            <video
              controls
      ...
      <section className="py-10 md:py-14 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-3xl md:rounded-4xl shadow-2xl group">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-br from-stone-900/85 via-stone-900/75 to-rose-900/85 transition-all duration-500" />
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 bg-gray-100" id="partners">
        <div className="max-w-7xl mx-auto">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <div className="bg-rose-900/50 backdrop-blur-lg rounded-se-[50px] md:rounded-se-[150px] rounded-es-[50px] p-8 sm:p-12 shadow-2xl transform transition-all duration-500 hover:scale-105">
            <Quote className="w-12 h-12 md:w-16 md:h-16 text-rose-400 mx-auto mb-6 opacity-50" aria-hidden="true" />
            <blockquote>
              <p className="text-xl sm:text-lg text-white leading-relaxed italic mb-6">
                <span className='text-rose-500'>"</span>Powerful and sustained change requires constant communication, not only
                throughout the rollout but after the major elements of the plan are in place. The
                more kinds of communication employed, the more effective they are.<span className='text-rose-500'>"</span>
              </p>
              <footer>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-3xl md:rounded-4xl shadow-2xl group">
            <img
              ...
              className="w-full h-full object-cover absolute inset-0 transition-transform duration-700 group-hover:scale-105"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-stone-950/95 via-stone-900/60 to-transparent transition-all duration-500" />
              ...
              <div className="max-w-4xl mx-auto animate-fade-in">
                ...
                <div className="grid grid-cols-3 gap-4 md:gap-6 mb-10 max-w-2xl mx-auto">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all">
                    ...
                    <p className="text-white/90 text-xs md:text-sm font-medium">Wellness Checks</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all">
                    <div className="text-2xl mb-2 text-white">✓</div>
                    <p className="text-white/90 text-xs md:text-sm font-medium">Mental Health Care</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all">
                    <div className="text-2xl mb-2 text-white">✓</div>
                    <p className="text-white/90 text-xs md:text-sm font-medium">Health Education</p>
                  </div>
                </div>
      ...
      <section className="py-3 md:py-4 px-4 sm:px-6 bg-gray-100" id="programs">
        <div className="max-w-7xl mx-auto text-center">
          <div className="relative p-8 text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black mb-4">
              OUR PROGRAMS
            </h2>
            <div className="w-24 h-1 bg-rose-400 mx-auto mb-6 md:mb-8 rounded-full" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
            {programs.map((program, index) => (
              <div className="relative overflow-hidden rounded-2xl md:rounded-3xl shadow-xl mb-2 group">
                <div className="absolute inset-0 bg-white" />
                <div className="relative p-4 sm:p-8 lg:p-10 text-center">
                  <h2 className="text-lg sm:text-xl font-bold mb-2">
                    {program.title}
                  </h2>
                  <div className="w-24 h-1 bg-rose-400 mx-auto mb-2 md:mb-2 rounded-full" />
                  <p className="text-sm sm:text-md text-gray-800 max-w-4xl mx-auto leading-relaxed text-justify">
                    {program.content}
                  </p>
                </div>
              </div>
          ...
          <button
            className="px-6 md:px-8 py-3 my-4 bg-rose-600 text-gray-100 rounded-full shadow-lg font-semibold hover:bg-gray-100 transition-all duration-300 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-4 focus:ring-white/50"
...
function HeroCarousel_({ slides }: any) {
  ...
  const navigate = (newSlide: number) => {
    setCurrentSlide(newSlide % slides.length);
    setIsAutoPlay(false);
  ...
  const titleVariants: Variants = {
    ...
    enter: {
      opacity: 1,
      y: 0,
      transition: { duration: 0.8, ease: [0.6, -0.05, 0.01, 0.99] as [number, number, number, number], delay: 0.2 },
    },
  };
  ...
  const subtitleVariants: Variants = {
    ...
    enter: {
      opacity: 1,
      y: 0,
      transition: { duration: 0.9, ease: [0.6, -0.05, 0.01, 0.99] as [number, number, number, number], delay: 0.3 },
    },
  };
  ...
  const descriptionVariants: Variants = {
    ...
    enter: {
      opacity: 1,
      x: 0,
      transition: { duration: 0.8, ease: [0.6, -0.05, 0.01, 0.99] as [number, number, number, number], delay: 0.4 },
    },
  };
  ...
  const ctaVariants: Variants = {
    ...
    enter: {
      ...
      scale: 1,
      transition: {
        duration: 0.7, ease: [0.6, -0.05, 0.01, 0.99] as [number, number, number, number],
        delay: 0.5
      },
    },
  };
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="absolute bottom-0 right-0 -mr-32 -mb-32"
          >
            <Icon className="w-[600px] h-[600px] text-white" strokeWidth={0.3} />
          </motion.div>
        </AnimatePresence>
      </div>

      <div className="relative h-full flex flex-col items-center justify-center px-8 md:px-16 lg:px-24">
        <motion.div className="max-w-5xl mx-auto text-center space-y-6">
          <AnimatePresence mode="wait">
            {current.title && (
              <motion.div
                ...
                exit="exit"
              >
                <h2 className="text-lg md:text-xl font-light tracking-[0.25em] text-white/80 uppercase">
                  {current.title}
                </h2>
              </motion.div>
            )}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight text-white uppercase leading-tight">
                {current.subtitle}
              </h1>
            </motion.div>
          </AnimatePresence>
            ...
            {current.cta && current.ctaLink && (
              ...
              >
                <a
                  ...
                  className="group relative inline-flex items-center gap-3 px-10 py-4 text-lg font-semibold text-white overflow-hidden"
                >
                  <span className="absolute inset-0 bg-white/10 backdrop-blur-md border border-white/30 rounded-full" />
                  <span className="absolute inset-0 bg-white rounded-full scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
                  <span className="relative z-10 group-hover:text-black transition-colors duration-300">
                    {current.cta}
                  </span>
                  <Heart className="relative z-10 w-5 h-5 group-hover:text-black transition-colors duration-300" fill="currentColor" />
                </a>
              </motion.div>
            )}
          </AnimatePresence>
      ...
      <button
        ...
        className="absolute left-8 top-1/2 -translate-y-1/2 z-20 p-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 transition-all duration-300 hover:scale-110 group"
        aria-label="Previous slide"
      >
      ...
      <button
        onClick={() => navigate(currentSlide + 1)}
        className="absolute right-8 top-1/2 -translate-y-1/2 z-20 p-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 transition-all duration-300 hover:scale-110 group"
        aria-label="Next slide"
      >
          ...
          >
            <motion.span
              ...
              animate={{
                ...
                backgroundColor: index === currentSlide ? 'rgba(255,255,255,1)' : 'rgba(255,255,255,0)',
              }}
              transition={{ duration: 0.3 }}
              className="block h-2 rounded-full border border-white/40"
            />
          </motion.button>
        ))}
      </div>
      ...
      >
        <h3 className="text-xl md:text-2xl font-bold text-white tracking-widest">
          ROSE OF JERICHO
        </h3>
      </motion.div>
    </div>
...
const slides = [
  ...
  // },
  {
    title: 'Hearts For Wellness',
    subtitle: 'Clean Water Project',
    description: 'Our mission trip\'s core focus is to contribute to the health care infrastructure.',
    cta: 'Donate Now',
    ctaLink: 'https://www.paypal.me/roseofjerichocd?locale.x=en_US',
...
export function Hero() {
  return (
    <div className="relative min-h-screen flex justify-center items-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      <img
        src={"assets/img/241182659_1447218092325649_729760777811111968_n.jpg"}
        alt=""
        className={`opacity-30 absolute inset-0 w-full h-full object-cover transition-transform duration-[20s] ease-linear`}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16 animate-fadeIn">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight">
            Rose of Jericho
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-rose-400 to-pink-500 mt-2">
              Community Development
            </span>
          </h1>
          <p className="text-xl sm:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Transforming lives through compassion, innovation, and sustainable community impact
          </p>
        </div>
        ...
        {/* <div className="mt-16 text-center animate-fadeIn" style={{ animationDelay: '600ms' }}>
          <div className="inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors cursor-pointer group">
...
export function HeroCard({
  ...
  return (
    <div
      className="group relative bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-500 hover:transform hover:scale-105 animate-fadeInUp"
      style={{ animationDelay }}
    >
      <div className={`absolute inset-0 bg-gradient-to-br ${gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500`} />

      <div className="relative p-8 h-full flex flex-col">
        {/* <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${gradient} p-3.5 mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-500`}>
          <Icon className="w-full h-full text-white" strokeWidth={2} />
        </div> */}

        {title && (
          <span className="text-xs font-semibold tracking-widest text-slate-400 mb-2 uppercase">
            {title}
          </span>
        )}
        ...
        {cta && ctaLink && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r ${gradient} text-white font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 group/btn mt-auto`}
          >
            <span>{cta}</span>
